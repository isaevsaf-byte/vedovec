...
export default defineType({
  ...
  fields: [
    ...
    localizedString("headline", "Заголовок (белый текст)", true),
    localizedString("headlineAccent", "Заголовок — акцент (синий текст)"),
    localizedText("description", "Описание (основной текст)"),
