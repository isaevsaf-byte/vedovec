...
export const metadata: Metadata = {
  title: "О нас",
  description:
    "Vedovec — таможенный брокер в Ташкенте. 7 лет на рынке, 12 специалистов, 2000+ деклараций в 2025 году. Комплексные решения по ВЭД для бизнеса.",
};
      ...
      <div className="bg-gradient-to-br from-primary to-primary-dark text-white pt-32 pb-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-slate-300 text-lg max-w-2xl">
            Надежный партнер в сфере ВЭД и таможенного оформления грузов.
            Помогаем бизнесу работать с международными рынками без таможенных сложностей с 2019 года.
          </p>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <div className="space-y-4 text-slate-600 leading-relaxed">
              <p>
                ООО «VEDOVEC» основан в 2019 году командой профессионалов с опытом работы в сфере ВЭД и таможенного законодательства. За это время мы оформили более 2000 грузовых таможенных деклараций в 2025 году, сопроводили две компании в получении статуса уполномоченного экономического оператора (УЭО) и провели клиентов через таможенный аудит.
              </p>
              <p>
                Специализируемся на товарах сегмента FMCG — среди наших клиентов крупнейшие дистрибьюторы портфелей DANONE, FERRERO, РУСАГРО, DOSHIRAK, DILMAH, SPLAT, а также официальные представительства MARS и INFAPRIM.
              </p>
              <p>
                Комплексный подход: от первичной консультации до полного сопровождения сделки. Персональный менеджер, ответственное и оперативное исполнение.
              </p>
            </div>
          </div>
          <div className="bg-slate-50 rounded-2xl p-8">
            <div className="grid grid-cols-2 gap-6">
              {[
                ...
                { number: "2000+", label: "деклараций в 2025 году" },
                { number: "12", label: "специалистов в команде" },
                { number: "2", label: "компании с УЭО статусом" },
              ].map((stat) => (
