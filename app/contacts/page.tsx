...
export const metadata: Metadata = {
  title: "Контакты",
  description:
    "Свяжитесь с таможенным брокером Vedovec в Ташкенте. Телефон, Telegram, WhatsApp, email и адрес офиса.",
};
...
const contactItems = [
  ...
  },
  {
    ...
    label: "Адрес",
    value: "г. Ташкент, ул. Амира Темура, 1, офис 405",
    ...
    <>
      ...
      <div className="bg-gradient-to-br from-primary to-primary-dark text-white pt-32 pb-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl md:text-5xl font-bold mt-2 mb-4">Контакты</h1>
          <p className="text-slate-300 text-lg max-w-2xl">
            Мы отвечаем быстро. Напишите в Telegram или оставьте заявку — свяжемся в течение 30 минут.
          </p>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div>
            ...
            <div className="mt-8 p-5 bg-slate-50 rounded-xl">
              <h3 className="font-semibold text-slate-800 mb-3">Режим работы</h3>
          ...
          {/* Form */}
          <div>
            <h2 className="text-2xl font-bold text-primary mb-8">Оставить заявку</h2>
